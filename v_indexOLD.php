...
<div class="container-fluid">
    <div class="row">
		...
		<div class="col-lg-2 col-md-5 col-sm-12 offset1" style="height: 230px; width: 230px; box-shadow: 3px 5px 10px rgba(0, 0, 0, .2) ; border: 1px solid rgba(0, 0, 0, .3); padding: 15px; border-radius: 3px; ">
			<div class="row">
				<div class="col-xs-12">
		...
		<div class="col-lg-6 col-md-7 offset1 window">
		    <? include('v_all.php'); ?>
		</div>
</div>

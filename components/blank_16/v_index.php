...
<br>
    <div class="form-group">
		...
		<div class="form-group">
			...
			<div class="form-group">
				<label for="">Рӯзҳои бистаришуда:</label>
				...
				<? if ($story->roh_g == 1)  { ?>
					<input type="checkbox" name="roh_g" checked> роҳ гашта метавонад.
				<?  } else { ?> 
					<input type="checkbox" name="roh_g"> роҳ гашта метавонад.
				<? } ?>
			</div>
		<div class="row">
			<div class="col-sm-3">
			...
			<div class="col-sm-4">
				...
				<input type="text" class="form-control input-sm" placeholder="Бо килогарм" name="vazn" id="vazn" onchange="ff()" value="<?=$story->vazn; ?>">
			</div>	
			<div class="col-sm-4">
				<label for="">Кад:</label>
				<input type="text" class="form-control input-sm" placeholder="Бо сантиметр" name="qad" id="qad" onchange="ff()" value="<?=$story->qad; ?>">
			</div>	
			<div class="col-sm-4">
		...
		<br>
		<div class="form-group">
			<label for="">Таъсири манфии дорухо, таҳаммулнопазири:</label>
...
<? if (isset($_GET['id'])) { ?> 
		...
		<div class="form-group">
			<label for="">4.Ҷои зисти доими:</label>
...
<? } else { ?>
		...
		<div class="row">
			...
			<div class="col-xs-4">
				<label for="exampleInputEmail1">№ Ҳуҷҷат:</label>
...
<? } ?>
		<br>
		<div class="form-group">
			<label for="">5.Ҷои кор, касб ва вазифа:</label>
		...
		<div class="form-group">	
			...
			<label for="">7.Ба беморхона аз рӯи нишонаҳои таъҷили:</label>
			<input name="rad" type="radio" value="1">Ҳа
		...
		<div class="row">
			<div class="col-xs-3">     <!-- дуруст намудан лозим дар як сатр -->
				...
				<label for="">Мудири бахш:</label><br>
	...
	<div class="row">
		<div class="col-lg-12">
		<h3 align="center"> <b>Таърихи клиникии беморӣ</b></h3>
			<label for="">Шикоятҳои бемор</label>
			<textarea name="tarih_bemori_kliniki" id="" cols="10" rows="3" class="form-control"></textarea>
		</div>
	</div>
	<br>
	<div class="form-group">
		<div class="row">
			<div class="col-lg-12">
				<b style="color: red">Anamnesis morbi:</b>
				<textarea name="am" id="" cols="10" rows="5" class="form-control"><?=$story->am; ?></textarea>
			</div>
		</div>
	</div>
	<div class="form-group">
		<div class="row">
			<div class="col-lg-12">
				<b style="color: red">Anamnesis vitae:</b>
				<textarea name="av" id="" cols="10" rows="5" class="form-control"><?=$story->av; ?></textarea>
			</div>
		</div>
	</div>
	<div class="form-group">
		<div class="row">
			<div class="col-lg-12">
				<b style="color: red">Status preasens:</b>
				<textarea name="sp" id="" cols="10" rows="5" class="form-control"><?=$story->sp; ?></textarea>
			</div>
		</div>
	</div>
	<div class="form-group">
		<div class="row">
			<div class="col-lg-12">
				<b style="color: red;">«Status chirurgicus»</b>
				<textarea name="sc" id="" cols="10" rows="5" class="form-control"><?=$story->sc; ?></textarea>
			</div>
		</div>
	</div>
	<div class="form-group">
		<div class="row">
			<div class="col-lg-12">
				<b>Накшаи ташхис ва тавобат:</b>
				<textarea name="ntt" id="" cols="10" rows="5" class="form-control"><?=$story->ntt; ?></textarea>
			</div>
		</div>
	</div>
		<div class="form-group">
			<div class="row">
				<div class="col-lg-12">
					<label for="">Рузнома:</label>
					<textarea name="tkb" class="form-control" id="" cols="10" rows="3"></textarea>
				</div>
			</div>
		</div>
	<br>
	...
	<input type="hidden" name="spart8" value="<?=$story->spart8; ?>">

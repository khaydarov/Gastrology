<?php 
    ...
    $cstory = getCommentsFromCstory($sid);
?>
<div class="row">
	<div class="col-lg-12">
		<form class="form-horizontal" role="form">
  			<div class="row">
  				<div class="col-sm-12">
  					...
  					<code><?=$story->num; ?></code>
					<a href="?option=add&id=<?=$sid;?>" class="btn btn-primary pull-right">Илова кардан</a>
...
<div class="panel panel-default">
    ...
    <div id="ist" class="panel-collapse collapse">
        <div class="panel-body">
            ...
            <div class="row">
              <div class="col-sm-12"><label for="">Руз ва вақти қабулшави: </label><code><?=$bemor['main']->data; ?></code></div>
            </div>
            <div class="row">
            ...
            <div class="row">
              <div class="col-sm-12"><label for="">Ташхиси клиники:</label><code><?=$story->t_k; ?></code></div>
            </div>
            <div class="row">
            ...
            <div class="row">
              <div class="col-sm-12">
                <p style="font-size: 15px; font-weight: bold;">Таърихи клиники бемори:</p>
                <code><?=$story->tarih_bemori_kliniki; ?></code>
              </div>
            </div>

            <div class="row">
              <div class="col-sm-12">
                <b style="display: block; color: red; text-align: center;">Anamnesis morbi:</b>
                <code><?=$story->am; ?></code>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                <b style="display: block; color: red; text-align: center;">Anamnesis vitae:</b>
                <code><?=$story->av; ?></code>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                <b style="display: block; color: red; text-align: center;">Status preasens:</b>
                <code><?=$story->sp; ?></code>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                <b style="display: block; color: red; text-align: center;">Status chirurgicus:</b>
                <code><?=$story->sc; ?></code>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <b style="display: block;">Накшаи ташхис ва тавобат:</b>
                <code><?=$story->ntt; ?></code>
              </div>
            </div>
            <br>
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <? for($i = 0; $i < count($cstory); $i++) { ?>
                   <? if ($cstory[$i]->uid == 16) { ?>
                    <div class="blocks" style="border: 1px solid rgba(0, 0, 0, .1); 
                                               border-left: 5px solid rgba(0, 0, 0, .3);
                                               background-color: rgba(0, 0, 233, .1);
                                               padding-left: 10px;
                                               padding-top: 5px;
                                               padding-bottom: 5px;
                                               margin-bottom: 5px;">
                      <b>Главврач: <?=getUserInfo($cstory[$i]->uid)->lastname.' '.getUserInfo($cstory[$i]->uid)->name;?>, Санаи таърих: <?=$cstory[$i]->data; ?></b><br>
                      <?=$cstory[$i]->comment; ?>
                    </div>
                   <?  } else { ?>
                    <div class="blocks" style="border: 1px solid rgba(0, 0, 0, .1); 
                                               ...
                                               padding-bottom: 5px;
                                               margin-bottom: 5px;">
                      <b>Духтур: <?=getUserInfo($cstory[$i]->uid)->lastname.' '.getUserInfo($cstory[$i]->uid)->name;?>, Санаи таърих: <?=$cstory[$i]->data; ?></b><br>
                      <?=$cstory[$i]->comment; ?>
                    </div>
                    <? } ?>
                <? } ?>
...
<!-- Эндоскопия -->
      <? include_once('analisys/blank_17/index.php'); ?>

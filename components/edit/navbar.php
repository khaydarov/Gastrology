...
<nav class="navbar navbar-default" role="navigation">
    ...
    <li><a href="?option=stats"><span class="glyphicon glyphicon-sort-by-attributes"></span> Омор</a></li>
	  ...
	  <form class="navbar-form navbar-left" role="search" method="GET" action="index.php">
	   ...
	   <ul class="nav navbar-nav navbar-right">
		  ...
		  <li class=""><a href="verify/logout.php"><span class="glyphicon glyphicon-log-out"></span> Аз барнома баромадан</a></li>
		</ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>